<template>
	<view class="content" @touchstart="touchstart" @touchend="touchend">
		...
		<ul :class="{active: isActive}">
			...
			<li class="option" :class="status == 2 ? 'red' : (question.answer == 'B' ? 'green' : '')"  @click="select('B')">
				<i>B</i>
				<view class="option-text">{{question.optionB}}</view>
			</li>
			<li class="option" :class="status == 3 ? 'red' : (question.answer == 'C' ? 'green' : '')" @click="select('C')">
				<i>C</i>
				<view class="option-text">{{question.optionC}}</view>
			</li>
			<li class="option" :class="status == 4 ? 'red' : (question.answer == 'D' ? 'green' : '')" @click="select('D')">
				<i>D</i>
